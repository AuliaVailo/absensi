...
<p><?=$this->session->flashdata('pesan');?></p>
	<div id="body">
            <form action="<?=site_url('admin_sdm/cari_validasi');?>" method="POST">
            	<select name="jenis_validasi">
            		<option value="">== PILIH KANTO ==</option>
            		<option value="kprk">KPRK Tuban 62300</option>
            		<option value="kpc">Kantor Pos Cabang</option>
            	</select>
                <input type="date" name="tanggal" value="<?=date('Y-m-d');?>" />
                <input type="submit" name="submit" value="Cari Data Validasi" />
            </form>
	</div>
